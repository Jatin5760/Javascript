...
console.log(`Hello my name is ${name} and my repo count is ${repoCount}`) // This is new way because of backtick we use string interpolation concept to concatinate strings.
